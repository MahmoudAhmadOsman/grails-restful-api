 <head>
   ...
   <section class="register_college">
          <div class="container">
			...
			<g:form action="save">
			   Full Name: <g:textField name="name" 
         class="form-control input-lg"
         value="${students.name}"
          placeholder="Enter your full name"/>
                 Date Of Birth: <g:textField name="dateOfBirth" class="form-control input-lg" 
                 value="${students.dateOfBirth}"
                 placeholder="ex. 10/10/1992"/>
                  Email address: <g:textField name="email" 
                  class="form-control input-lg"
                  value="${students.email}"
                   placeholder="Enter your email"/>
                   Phone: Number <g:textField name="phone" 
                   class="form-control input-lg" 
